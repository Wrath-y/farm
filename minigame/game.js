...
let managerConfig = {
  DATA_FILE_MD5: 'ae1e9346592bc9ac',
  CODE_FILE_MD5: '528279660231879e',
  GAME_NAME: 'webgl',
  APPID: 'wxd11c47fa600c13d9',
  // DATA_FILE_SIZE: "$DATA_FILE_SIZE",
  DATA_CDN: 'https://wrath-game.oss-cn-shanghai.aliyuncs.com/farm',
  // 资源包是否作为小游戏分包加载
    ...
    managerConfig = {
      ...
      loadingPageConfig: {
        ...
        materialConfig: {
          ...
          backgroundImage: 'images/background.jpg', // 背景图片，推荐使用小游戏包内图片；当有视频时，可作为视频加载时的封面
          backgroundVideo: '', // 加载视频，网络url
