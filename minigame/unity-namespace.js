...
const unityNamespace = {
  ...
  uintyColorSpace: 'Gamma', //Color Space: Gamma、Linear、Uninitialized(未初始化的颜色空间)
  convertPluginVersion: '202304262014',
  ...
  texturesHashLength: 8, // 纹理中的hash长度
  texturesPath: 'Assets/Textures', // 纹理存放路径
  needCacheTextures: true, // 是否需要缓存纹理,
